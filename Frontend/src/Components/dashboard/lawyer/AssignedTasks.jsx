...
const AssignedTasks = ({ caseId }) => {
  const { tasks, loading: fetchLoading } = useFetchAssignedTasks(caseId);
  ...
  return (
    ...
    >
      <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-lg">
        ...
        <div className="h-[5px] bg-blue-500 max-w-[500px] rounded-full my-4"></div>
