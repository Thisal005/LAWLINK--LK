  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-100 to-blue-100 rounded-full filter blur-2xl opacity-50 animate-pulse"></div>
        <div className="absolute bottom-0 left-0 w-28 h-28 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full filter blur-2xl opacity-50 animate-pulse animation-delay-2000"></div>
      </div>
